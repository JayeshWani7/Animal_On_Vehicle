...
gameTitle = "Animal on Vehicle"
loadPrcFileData("", f"window-title {gameTitle}")
loadPrcFileData("","win-size 1050 720")
...
""")
        ...
        text = TextNode("text")
        text.setText("""\
A Major Project by Student of Government Polytechnic, Mumbai

Under the guidence of Prof. Jijnasa Patil

Students - Jayesh Wani, Harsh Pol, Harsh Kanse, Tushar Khandare, Eeshaan Dhuru 

Some Gaming Models and Assets from Alice Gallery

[Audio]Main music adapted from Purple Passion by Diana Boncheva
[Fonts]American Captain by fontmeme.com
